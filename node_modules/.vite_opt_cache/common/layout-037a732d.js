import { Y as isObject, ag as setToString, ah as overRest, ai as root, ac as baseRest, aj as isIterateeCall, Q as keysIn, a4 as eq, K as isArrayLike, J as isArray, aa as baseFor, ak as baseAssignValue, a9 as identity, a8 as isIndex, a2 as assignValue, X as baseUnary, ae as constant, al as merge } from './mermaid.core-0b71f95d.js';
import { i as isSymbol, b as baseFlatten, a as baseClone, c as baseIteratee, k as keys, d as baseFindIndex, e as baseEach, f as arrayMap, g as castFunction, h as baseForOwn, j as hasPath, l as castPath, t as toKey, m as baseGet, n as hasIn, o as toString, p as forEach, G as Graph, q as isUndefined, r as filter, v as values, s as reduce } from './graph-1ef514c9.js';
...
function order(g) {
  var maxRank$1 = maxRank(g),
    downLayerGraphs = buildLayerGraphs(g, range(1, maxRank$1 + 1), 'inEdges'),
    upLayerGraphs = buildLayerGraphs(g, range(maxRank$1 - 1, -1, -1), 'outEdges');
...
export { defaults as d, layout as l, map as m, pick as p, range as r, uniqueId as u };
