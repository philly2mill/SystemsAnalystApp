import { aw as define, ax as extend, ay as Rgb, az as Color, aA as rgbConvert, aB as nogamma, aC as hue, aD as dayjs_min, c as getConfig, s as setAccTitle, g as getAccTitle, x as setDiagramTitle, y as getDiagramTitle, b as setAccDescription, a as getAccDescription, A as clear$1, m as index, l as log$1, h as select, i as configureSvgSize, j as common$1, z as utils } from './mermaid.core-0b71f95d.js';
import { c as createCommonjsModule, a as commonjsGlobal } from './_commonjsHelpers-308f4cc1.js';
import { b as bisector, t as tickStep, c as continuous, a as copy, l as linear } from './linear-78b12401.js';
import { i as initRange } from './init-0da31cd9.js';
...
const checkTaskDates = function(task, dateFormat2, excludes2, includes2) {
  ...
  if (task.startTime instanceof Date) {
    startTime = dayjs_min(task.startTime);
  } else {
    startTime = dayjs_min(task.startTime, dateFormat2, true);
  }
  startTime = startTime.add(1, "d");
  let originalEndTime;
  if (task.endTime instanceof Date) {
    originalEndTime = dayjs_min(task.endTime);
  } else {
    originalEndTime = dayjs_min(task.endTime, dateFormat2, true);
  }
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  let mDate = dayjs_min(str, dateFormat2.trim(), true);
  if (mDate.isValid()) {
    return mDate.toDate();
  } else {
...
const getEndDate = function(prevTime, dateFormat2, str, inclusive = false) {
  ...
  let parsedDate = dayjs_min(str, dateFormat2.trim(), true);
  ...
  let endTime = dayjs_min(prevTime);
...
const compileData = function(prevTask, dataStr) {
  ...
  if (endTimeData) {
    ...
    task.manualEndTime = dayjs_min(endTimeData, "YYYY-MM-DD", true).isValid();
  ...
  const compileTask = function(pos) {
    ...
    if (rawTasks[pos].startTime) {
      ...
      if (rawTasks[pos].endTime) {
        ...
        rawTasks[pos].manualEndTime = dayjs_min(
          rawTasks[pos].raw.endTime.data,
          "YYYY-MM-DD",
          true
        ).isValid();
...
const setLink = function(ids, _linkStr) {
  ...
  if (getConfig().securityLevel !== "loose") {
    linkStr = index.sanitizeUrl(_linkStr);
  }
