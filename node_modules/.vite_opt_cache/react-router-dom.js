import './common/_commonjsHelpers-308f4cc1.js';
import { r as react, R as React } from './common/index-6d41bba3.js';
import { R as ReactDOM } from './common/index-edf7a11b.js';
...
const Link = /*#__PURE__*/react.forwardRef(function LinkWithRef(_ref7, ref) {
  ...
  return (
    ...
    react.createElement("a", _extends$2({}, rest, {
...
const NavLink = /*#__PURE__*/react.forwardRef(function NavLinkWithRef(_ref8, ref) {
  ...
  return /*#__PURE__*/react.createElement(Link, _extends$2({}, rest, {
...
function useSubmit() {
  let {
    router
  } = useDataRouterContext$1(DataRouterHook$1.UseSubmit);
  let {
    basename
  } = react.useContext(NavigationContext);
...
function useFetcher(_temp3) {
  ...
  let {
    router
  } = useDataRouterContext$1(DataRouterHook$1.UseFetcher);
  let state = useDataRouterState$1(DataRouterStateHook$1.UseFetcher);
  ...
  let submit = react.useCallback((target, opts) => {
    submitImpl(target, _extends$2({}, opts, {
      navigate: false,
      fetcherKey
    }));
  ...
  let FetcherForm = react.useMemo(() => {
    let FetcherForm = /*#__PURE__*/react.forwardRef((props, ref) => {
      return /*#__PURE__*/react.createElement(Form, _extends$2({}, props, {
        navigate: false,
  ...
  let fetcherWithComponents = react.useMemo(() => _extends$2({
    Form: FetcherForm,
    submit,
    load
  }, fetcher, {
...
function useFetchers() {
  let state = useDataRouterState$1(DataRouterStateHook$1.UseFetchers);
  return Array.from(state.fetchers.entries()).map(_ref11 => {
    let [key, fetcher] = _ref11;
    return _extends$2({}, fetcher, {
      key
    });
  });
}
...
function useScrollRestoration(_temp4) {
  ...
  let {
    router
  } = useDataRouterContext$1(DataRouterHook$1.UseScrollRestoration);
  let {
    restoreScrollPosition,
    preventScrollReset
  } = useDataRouterState$1(DataRouterStateHook$1.UseScrollRestoration);
  let {
    basename
  } = react.useContext(NavigationContext);
  let location = useLocation();
...
function useViewTransitionState(to, opts) {
  ...
  let {
    basename
  } = useDataRouterContext$1(DataRouterHook$1.useViewTransitionState);
  let path = useResolvedPath(to, {
